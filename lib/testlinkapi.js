 ...
 */
TestLinkApi.prototype.getProjectPlatforms = function(params, callback, proxy) {
    var obj = {
    ...
    postToAPI(this.url, obj, callback, proxy);
};
 ...
 *  @param   {function}callback
 */
TestLinkApi.prototype.getTestCaseAttachments = function(params, downloadpath, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestCaseCustomFieldDesignValue = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestCasesForTestSuite = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestPlanPlatforms = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestProjectByName = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestSuitesForTestPlan = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 *  @return {Json Object}JSON Object for TestSuite
 */
TestLinkApi.prototype.getTestSuitesForTestSuite = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 *  @param  {function}callback
 */
TestLinkApi.prototype.uploadTestCaseAttachment = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
 ...
 */
TestLinkApi.prototype.getExecCountersByBuild = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 *  @return {Json Object}JSON Object for TestSuite
 */
TestLinkApi.prototype.getFirstLevelTestSuitesForTestProject = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getFullPath = function(params, callback, proxy) {
    var obj = {
 ...
 */
TestLinkApi.prototype.getLastExecutionResult = function(params, callback, proxy) {
    var obj = {
 ...
 */
TestLinkApi.prototype.removePlatformFromTestPlan = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.reportTCResult = function(params, callback, proxy) {
    var obj = {
 ...
 */
TestLinkApi.prototype.setTestCaseExecutionType = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 */
TestLinkApi.prototype.getTestLinkVersion = function(callback, proxy) {
    var obj = {
        methodName: "testLinkVersion"
    };
    u.addValueTypeObject(obj, "devKey", this.devkey, "string");
    u.postToAPI(this.url, obj, callback, proxy);
};
 ...
 */
TestLinkApi.prototype.updateTestCase = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
 ...
 *  @return {Json object}JSON Object for TestCase
 */
TestLinkApi.prototype.updateTestCaseCustomFieldDesignValue = function(params, callback, proxy) {
    var post = utilites.postCompose(this.url, proxy),
        inputObject = {
...
TestLinkApi.prototype.about = function(callback, proxy) {
    var obj = {
        methodName: "about"
    };
    u.addValueTypeObject(obj, "devKey", this.devkey, "string");
...
var postToAPI = function(url, object, callback, proxy) {
    var post = utilites.postCompose(url, proxy),
